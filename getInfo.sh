...
#echo ""
echo -e "${RED}hpc4you toolkit solo${PLAIN}, for workstation,\t starts at 43 USD."
echo -e "${GREEN}hpc4you toolkit v2.0 ${PLAIN}, setup HPC by yourself,\t starts at 93 USD."
echo -e "${BLUE}hpc4you toolkit v3.0 ${PLAIN}, setup HPC with Web Interface,\t starts at 143 USD."
echo ""
