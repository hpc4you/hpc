...
echo ""
echo -e "Upload file (${RED}`hostname`-hardware.dat${PLAIN}) as attachment..."
...
#echo ""
echo -e "${RED}hpc4you toolkit solo${PLAIN}, for workstation,\t starts at 248 RMB."
echo -e "${GREEN}hpc4you toolkit${PLAIN}, setup HPC by yourself,\t starts at 398 RMB."
echo ""
